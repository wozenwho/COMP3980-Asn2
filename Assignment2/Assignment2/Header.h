...
#define tagDisplayAreaRight		600
#define tagDisplayAreaBottom	999

#define connectDeviceSuccess	0
#define connectDeviceNoReader	1
#define connectDeviceNoDevice	2
